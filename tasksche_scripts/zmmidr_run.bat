...
set "SCRIPT_PATH=C:\Users\anniec\Documents\TAWA\AutoScript\ETL_SAP\pipelines\etl_zmmidr_oun.py"
set "LOG_DIR=C:\Users\anniec\Documents\TAWA\AutoScript\ETL_SAP\logs\zmmidr_logs"
set "LOG_FILE=%LOG_DIR%\zmmidr_log_%DATE_STAMP%.txt"
